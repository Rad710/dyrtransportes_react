...
export const DyRTransportesIcon = () => {
    return (
        <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
            <SvgIcon sx={{ width: 100, marginLeft: "-2rem", marginTop: "-0.4rem" }}>
                <svg
                    fill="#000000"
                    version="1.1"
                    id="Capa_1"
            ...
            <Typography
                ...
                sx={{
                    fontWeight: "bold",
                    marginLeft: "-2.2rem", // Adjust this value to fine-tune the spacing between icon and text
                }}
            >
                DyR&nbsp;Transportes
            </Typography>
